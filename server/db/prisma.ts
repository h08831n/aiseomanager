...
const fallbackClient: any = {
  ...
  crawlFrontierEntry: createInMemoryTable('crawlFrontierEntry'),
  crawledPage: createInMemoryTable('crawledPage'),
  internalLinkEdge: createInMemoryTable('internalLinkEdge'),
  crawlIssue: createInMemoryTable('crawlIssue'),
  websiteSettings: createInMemoryTable('websiteSettings'),
  searchAnalyticsDaily: createInMemoryTable('searchAnalyticsDaily'),
  topicCluster: createInMemoryTable('topicCluster'),
  topicSubtopic: createInMemoryTable('topicSubtopic'),
